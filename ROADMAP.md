...
- **Discovery first where it's earned:** fuzzy items file as discovery issues (problem +
  ...
  spec. Currently: review-code v2's design spike (#474, discovery ahead of the S2 build),
  the spec-panel codex-seat experiment (#34, discovery ahead of the S3 lane's panel work), and
  the guardian design spike (#41, discovery ahead of the G1 build).
