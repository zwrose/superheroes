...
| **1 · One issue, supervised** *(next)* | prove the full loop on a single work-item, with a human watching | one work-item taken Discovery→Integrate end-to-end; evals gate every step | + **define** (spec/plan/tasks), the **review trio** (review-spec/plan/tasks) | — |
...
| **2b · Define depth** | the front half gets serious: deeper Plan + recursion | richer Plan + the full review trio; recursive human-approved decomposition; living calibration that evolves with the project | define, review-crew (deepened) | — |
