...
*Consumers:* C3 (owns route selection under the judgment rule), C8 (adoption pass re-routes against these names). *(Cross-spec note, not a consumer: the detective spec's FR-1 owns the fire condition; its Assumptions section carries the pre-ship transition.)*
...
- **2026-08-08 (round-3 fold, all-mechanical):** R6/R9 transition glosses stripped to pure
  pointers (A4r3/B4r3/C2r3); R3 gains the both-directions completeness rule (A1r3's
  sharpening — missing required quotes fail).
