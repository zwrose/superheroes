...
**Anchor:** spec `front-half-sdlc-core-6181ee` §Spec content (FR-18..FR-25) — owner-approved 2026-08-07.
...
- Spec template: Dispositions table (decision axis × Show-it? × where/why) with the six
  seed dimensions; Amendments log section with R4's entry format.
