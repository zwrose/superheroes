...
| A | FR-B6 | 6 | Acceptance (rule, the sentence layer; ru | the technical-writing modes (reference, procedure, explanation) and the unslop filter, minus its met… | **C3** |
