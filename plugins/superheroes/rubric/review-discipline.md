...
lanes. **Crossing twice the estimate is the tripwire**; for a range estimate, twice its upper end is the
line (for 40–90, 180). The first commit past 2× is the crossing,
