...
not that it enumerates every skill, so a newly-added skill (here `superheroes:acceptance`)
...
def test_acceptance_skill_is_registered_in_codex_manifest():
    assert "acceptance" in _codex_skills()
