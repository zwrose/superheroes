...
- **broken subject** (`plugins/superheroes/lib/model_registry.py`, `gpt-6-astra` row): omitted `"registration": "probe-pending",  # fail-receipt R-D1` after `"override_only": False,`
...
- **broken subject** (`plugins/superheroes/lib/model_registry.py`, `gpt-6-astra` row): omitted `"registration": "probe-pending",  # fail-receipt R-D2` after `"override_only": False,`
...
- **broken subject** (`plugins/superheroes/lib/model_registry.py`, `gpt-6-astra` row): omitted `"registration": "probe-pending",  # fail-receipt R-D3` after `"override_only": False,`
