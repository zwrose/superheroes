...
# `cli_contract` and `dispatch_guard` load because the allowlist is consulted at the entry
# chokepoint (`seat_bundle.resolve_entry`), so any dispatch entry imports them.
