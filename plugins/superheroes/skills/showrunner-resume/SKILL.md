...
Lanes: vet 0; re-arm 0; adopt 0; parked 0; unresolved 1 (#350 — row 5: leader positively not live, PR ready, receipt not establishable so row 3 fails, and a ready PR never matches row 4 — not relaunched).
Watches: wave-e not armed — no row-2 lane in the batch. Owner: #350 handed back but its review receipt could not be established — vet it by hand.
```
