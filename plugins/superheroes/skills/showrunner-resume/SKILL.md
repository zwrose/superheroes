...
Lanes: vet 0; re-arm 0; adopt 1 (#340 — row 4: leader positively not live, PR not both ready and receipted (draft), park-record read completed no park record, unpushed-work sweep ran and residue durable — one unpushed commit pushed to branch wh/340-fix at abc1234; terminal outcome died recorded before adoption); parked 0; unresolved 0.
