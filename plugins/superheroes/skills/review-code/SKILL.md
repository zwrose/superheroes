...
A green verify exit is **not** evidence the test suite passed — calibration may run no tests at all. Test receipts: CI (workflow + head sha) or the build's ordered suite run (`skills/review-code/reference/setup.md`).
