...
| Over-counting Nits and burying the real findings                   | Nit cap (5) applies the same as in `/superheroes:review-code`. A Nit avalanche in a debt audit is signal that the auditor is reaching — dedupe or drop.                    |
